                ...
                <div class="col-lg-12">
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])) 
                        {
                            ...
                            $ca_info_1 = mysqli_real_escape_string($connection, $_POST['ca_info_1']);
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea class="form-control" type="text" name="ca_info_1" rows="10"
                                    cols="30"><?php echo $ca_info_1 ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="ca_info_2">Info 2</label>
                                <br>
                                <textarea class="form-control" type="text" name="ca_info_2" rows="10"
                                    cols="30"><?php echo $ca_info_2 ?></textarea>
                            </div>
