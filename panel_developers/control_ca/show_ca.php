                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($select_ca))
                                {
                                    ...
                                    echo "<td><img src = '../../images/{$row['ca_image']}' class='img-responsive' width='200'></td>";
                                    echo "<td><a href = 'show_ca_more.php?ca_id={$row['ca_id']}'>Show More</a></td>";
                                    echo "<td><a href='edit_ca.php?edit={$row['ca_id']}'>Edit</a></td>";
                                    echo "<td><a href='delete_ca.php?delete={$row['ca_id']}'>Delete</a></td>";
                                    echo "</tr>";
                                }
                            ?>
                        </tbody>
